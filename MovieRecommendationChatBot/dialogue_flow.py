from functions import initialize_conversation, initialize_conv_reco, get_chat_model_completions, moderation_check, \
    intent_confirmation_layer, dictionary_present, recommendation_validation, \
    compare_movies_with_user_req
    ...
    while(user_input != "exit"):
        ...
        if top_3_laptops is None:
            ...
            if "No" in confirmation:
                ...
                print('\n' + response + '\n')
                print("Thank you for providing all the information. Kindly wait, while I fetch the recommendations: \n")
                top_3_laptops = compare_movies_with_user_req(response)

                validated_reco = recommendation_validation(top_3_laptops)

                if len(validated_reco) == 0:
                    print("Sorry, Currently we do not have the recommendations that suit your preferences. Connecting you to a human expert.")
                    break
