...
def invite():
    ...
    prompt = 'Remember your system message and that you are an intelligent movie recommendation assistent.Do not entertain any request that is not for movie recommendations.'
